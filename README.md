...
Посмотреть можно в ветке ветке **master**. Инструмент позволяет на уровне языка жестко задавать границы модулей. Самый строгий инструмент - отлавливает ошибки на этапе компиляция. Есть поддержка Intellij Idea. 
...
Посмотреть можно в ветке ветке **master**. Инструмент позволяет конфигурировать модули через аннотации на пакетах. Есть возможность верификации правил и генерирования документации в формате UML и adoc.
