...
public class TransportationRequestsController implements TransportationRequestV1Api {
    ...
    private final CreateTransportationRequestCommandHandler transportationRequestCommandHandler;
    ...
    public ResponseEntity<Void> postV1TransportationRequests(TransportationRequestDTO transportationRequestDTO) {
        transportationRequestCommandHandler.handle(
            new CreateTransportationRequestCommand(map(transportationRequestDTO)));
